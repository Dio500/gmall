...
public class RedisConst {
    ...
    public static final String SECKILL_ORDERS = "seckill:orders";//已经创建的订单
    public static final String SECKILL_ORDERS_USERS = "seckill:orders:users";//已经创建订单的用户列表
    public static final String SECKILL_STOCK_PREFIX = "seckill:stock:";// 等待秒杀的商品的库存信息，用集合的rightPop来抢库存
    public static final String SECKILL_USER = "seckill:user:";// 用来判断用户之前是否已经创建过订单
    //用户锁定时间 单位：秒
